...
class SquareToCircle(Scene):
    def construct(self):
        ...
        self.wait(2)  # Dialog queue (for client explanation)
        ...
        self.wait(2)  # Dialog queue 2 (for server explanation)
        ###############
        ...
        self.wait(2)  # client first makes a *REQUEST* to the server
